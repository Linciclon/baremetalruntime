...
ifneq ($(SECURE_INTERRUPT_LATENCY),)
CPPFLAGS+=-DSECURE_INTERRUPT_LATENCY
endif
ifneq ($(NON_SECURE_WORLD_INT_LAT),)
CPPFLAGS+=-DNON_SECURE_WORLD_INT_LAT
endif
ifneq ($(RUN_INSIDE_VM),)
CPPFLAGS+=-DRUN_INSIDE_VM
endif
